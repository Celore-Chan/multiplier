...
HD_PWD='D:/coding/computer_organization/exp2nd/multi/multi/multi.runs/design_1_and_gate_10_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_and_gate_10_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_and_gate_10_7.tcl
