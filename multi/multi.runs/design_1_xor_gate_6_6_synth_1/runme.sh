...
HD_PWD='D:/coding/computer_organization/exp2nd/multi/multi/multi.runs/design_1_xor_gate_6_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xor_gate_6_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xor_gate_6_6.tcl
